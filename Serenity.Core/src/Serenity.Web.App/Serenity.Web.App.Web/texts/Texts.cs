    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your SampleSession01 Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your SampleSession01 Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "SampleSession01";
        }
